...
angular.module('three')
    .directive('glFirstPersonControls', function () {
        return {
            restrict: 'A',
            require: '^glScene',
            link: function (scope, element, attrs, sceneCtrl) {

                var controls = new THREE.MyFirstPersonControls(sceneCtrl.cameraService.camera, sceneCtrl.rendererService.renderer.domElement);
