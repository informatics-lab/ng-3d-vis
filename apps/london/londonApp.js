...
angular.module('desktopApp', ["informatics-badge-directive", "three", 'toaster', 'ngAnimate'])
    .controller('AppCtrl', ['$scope', '$timeout', 'glSceneService', 'glCameraService', 'glRendererService', 'glImageService','glCoordService', 'glSocketService', function ($scope, $timeout, glSceneService, glCameraService, glRendererService, glImageService, glCoordService, glSocketService) {
        ...
        *******************************/
        ...
        //VIDEO DATA
        glImageService.loadData($scope.videoUrl);
